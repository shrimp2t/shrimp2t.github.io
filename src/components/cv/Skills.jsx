        ...
        <div class="o-grid">
          ...
          <div class="o-grid__col-sm-6">
            <div class="o-content">
              ...
              <div class="c-progress-bar  o-content__body  t-border-color-bg  u-mt-text">
                <div class="a-progress-bar  c-progress-bar__filler  t-primary-bg in-view" data-percent="75"></div>
              </div>
            </div>
          </div>
          ...
          <div class="o-grid__col-sm-6">
            <div class="o-content">
              ...
              <div class="c-progress-bar  o-content__body  t-border-color-bg  u-mt-text">
                <div class="a-progress-bar  c-progress-bar__filler  t-primary-bg in-view" data-percent="60" ></div>
              </div>
            </div>
          </div>
